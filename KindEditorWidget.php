...
class KindEditorWidget extends InputWidget
{
    ...
    public function registerClientScript()
    {
        ...
        if ($themeType != 'default') {
            $view->registerCssFile($asset->baseUrl . "/themes/{$themeType}/{$themeType}.css", ['depends' => '\sailinghang\kindeditor\KindEditorAsset']);
        }
        $preJs = '';
        if ($themeType == 'qq') {
...
";
        ...
        $view->registerJsFile($asset->baseUrl . '/lang/' . $this->clientOptions['langType'] . '.js', ['depends' => '\sailinghang\kindeditor\KindEditorAsset']);
        $id = $this->options['id'];
